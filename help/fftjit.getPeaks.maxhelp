...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 287.0, 189.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "r toDisplay"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.0, 540.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "s toDisplay"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 35.5, 411.0, 30.0, 22.0 ],
					"style" : "",
					"text" : "jit.!-"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 13.0, 471.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 216.0, 292.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 140.0, 292.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 324.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "reach $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 216.0, 324.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "thresh $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 508.0, 64.0, 22.0 ],
					"style" : "",
					"text" : "switch 3 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 287.0, 222.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "jit.unpack 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 35.5, 378.0, 82.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 637.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.5, 57.0, 423.0, 20.0 ],
					"style" : "",
					"text" : "Finds the frequency peaks around each local been over the given reach"
				}
...
,
					...
					"patching_rect" : [ 12.0, 113.0, 150.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 13.0, 569.0, 112.0, 22.0 ],
					"style" : "",
...
, 			{
				...
				"bootpath" : "~/Documents/Max 7/Packages/FFTJIT/code",
