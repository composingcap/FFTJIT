...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 155.0, 195.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.5, 195.0, 146.0, 20.0 ],
					"presentation_rect" : [ 51.5, 181.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "clear empties the buffer"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Performs a running average on incoming matrices."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 12.0, 252.0, 62.0, 22.0 ],
					"style" : "",
					"text" : "fftjit.mean"
				}
