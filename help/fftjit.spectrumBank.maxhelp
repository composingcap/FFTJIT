...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 384.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "overflow $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.0, 180.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "thin 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 324.0, 147.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 324.0, 183.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 246.0, 191.0, 49.0, 22.0 ],
					"style" : "",
					"text" : "size $1"
				}
...
,
					"patching_rect" : [ 189.0, 384.0, 361.0, 245.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 23.0, 299.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "drunk 50 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 12.0, 459.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "route frame"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 23.0, 347.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 384.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "frame $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 429.0, 131.0, 22.0 ],
					"style" : "",
					"text" : "fftjit.spectrumBank this"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 189.0, 230.0, 128.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 189.0, 299.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "route stft"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 189.0, 266.0, 131.0, 22.0 ],
					"style" : "",
					"text" : "fftjit.spectrumBank this"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 191.0, 148.0, 22.0 ],
					"style" : "",
					"text" : "fftjit.spectrumBank this 50"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.5, 58.0, 368.0, 33.0 ],
					"style" : "",
					"text" : "fftjit.spectrumBank is a buffer for fftjit matrix frames.  Frames by be called by their index or output with a bang."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 189.0, 347.0, 71.0, 22.0 ],
					"style" : "",
					"text" : "jit.unpack 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 12.0, 503.0, 112.0, 22.0 ],
					"style" : "",
