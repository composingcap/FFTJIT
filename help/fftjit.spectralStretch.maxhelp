...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 239.0, 192.0, 275.0, 20.0 ],
					"text" : "Takes an interval an converts it to a stretch factor"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.0, 148.0, 176.0, 20.0 ],
					"text" : "Stretch factor. 2 is an octave"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 162.0, 147.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 162.0, 471.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.5, 59.0, 553.0, 33.0 ],
					"text" : "Stretches an fftjit matrix.  In the frequency domain this can be thought of as transposition.  This method is NOT phase vocoding as is is a shift in spectra not a modulation in phase."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 246.0, 70.0, 22.0 ],
					"text" : "bang, clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "", "" ],
					"patching_rect" : [ 12.0, 181.0, 40.0, 22.0 ],
					"text" : "t b l l"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 162.0, 324.0, 46.0, 22.0 ],
					"text" : "fftjit.++"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 371.0, 323.0, 71.0, 22.0 ],
					"text" : "jit.unpack 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 371.0, 357.0, 501.0, 184.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 187.0, 192.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.0, 222.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 162.0, 269.0, 112.0, 22.0 ],
					"text" : "fftjit.spectralStretch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 162.0, 403.0, 112.0, 22.0 ],
