...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 353.5, 310.0, 150.0, 20.0 ],
					"text" : "Center and Width in bins"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 277.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 140.0, 222.0, 107.0, 22.0 ],
					"text" : "snapshot~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 140.0, 190.0, 63.0, 22.0 ],
					"text" : "cycle~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.0, 273.0, 107.0, 22.0 ],
					"text" : "scale -1. 1. 50 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.0, 345.0, 84.0, 22.0 ],
					"text" : "prepend width"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 336.0, 89.0, 22.0 ],
					"text" : "prepend center"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 282.0, 308.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 18.5, 580.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "FFT based band pass filter"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 18.5, 376.0, 124.0, 22.0 ],
					"text" : "fftjit.bandPass 500 50"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 178.0, 461.0, 71.0, 22.0 ],
					"text" : "jit.unpack 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 178.0, 495.0, 501.0, 184.0 ]
				}
...
,
					...
					"patching_rect" : [ 18.5, 106.0, 150.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 18.5, 512.0, 112.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 18.5, 145.0, 109.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 118.0, 176.5, 237.5, 176.5 ],
					"source" : [ "obj-66", 1 ]
				}
