...
,
		"classnamespace" : "box",
		"rect" : [ 1072.0, 927.0, 1009.0, 810.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 119.0, 136.0, 55.0, 22.0 ],
					"text" : "plane $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 293.0, 161.0, 55.0, 22.0 ],
					"text" : "plane $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 484.0, 118.0, 40.0, 22.0 ],
					"text" : "t l 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 535.5, 118.0, 50.5, 22.0 ],
					"text" : "t b l 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 571.5, 174.0, 152.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 656.0, 2.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 656.0, 29.0, 72.0, 22.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 709.0, 87.0, 65.0, 22.0 ],
					"text" : "route clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 709.0, 123.0, 55.0, 22.0 ],
					"text" : "jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 489.0, 83.0, 184.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 489.0, 287.0, 163.0, 22.0 ],
